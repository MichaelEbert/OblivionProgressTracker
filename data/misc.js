{"version":2,"elements":[
	...
	,{"name":"Fame","elements":[{"id":25,"name":"Fame","weight":5,"type":"number","max":198}]}
	,{"name":"Pilgrim's Grace","weight":0,"elements":[
		 {"id":8,"name":"Akatosh"}
		,{"id":9,"name":"Arkay"}
		,{"id":10,"name":"Dibella"}
		,{"id":11,"name":"Julianos"}
		...
		,{"id":13,"name":"Mara"}
		,{"id":14,"name":"Stendarr"}
		,{"id":15,"name":"Talos (Tiber Septim)"}
		,{"id":16,"name":"Zenithar"}
	]}
	,{"name":"Houses","weight":1,"elements":[
		 {"id":17,"name":"Benirus Manor"}
		,{"id":18,"name":"Bravil House for Sale"}
		,{"id":19,"name":"Bruma House for Sale"}
		,{"id":20,"name":"Cheydinhal House for Sale"}
		,{"id":21,"name":"Arborwatch"}
		,{"id":22,"name":"Shack for Sale"}
